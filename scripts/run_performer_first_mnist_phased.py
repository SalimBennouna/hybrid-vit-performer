...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run MNIST PerformerFirst RELU batch then PerformerFirst SOFTMAX batch."
    )
    parser.add_argument(
        "--device",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Seconds to wait between RELU and SOFTMAX batches. Default: 0 (no wait).",
    )
